...
public class WorldGenMinableNFC extends WorldGenerator {
	
	public WorldGenMinableNFC(PropsBlock block, int spawnCount)
    {
        this(block.block_id, spawnCount, block.block_metadata);
    }
	
	public WorldGenMinableNFC(int id, int spawnCount)
    {
        this(id, spawnCount, 0);
    }
	
	public WorldGenMinableNFC(int id, int spawnCount, int metadata)
    {
        minableBlockId = id;
        numberOfBlocks = spawnCount;
            ...
            for(int k2 = i1; k2 <= l1; k2++)
            {
                ...
                for(int l2 = j1; l2 <= i2; l2++)
                {
                    ...
                    for(int i3 = k1; i3 <= j2; i3++)
                    {
                        ...
                        {
                            world.setBlockAndMetadata(k2, l2, i3, minableBlockId, minableBlockMetadata);
                        }
                    }
    ...
    private final int minableBlockMetadata;
}
